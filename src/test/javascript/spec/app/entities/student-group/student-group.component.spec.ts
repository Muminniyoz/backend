...
import { StudentGroupComponent } from 'app/entities/student-group/student-group.component';
...
describe('Component Tests', () => {
  describe('StudentGroup Management Component', () => {
    let comp: StudentGroupComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(StudentGroupComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.studentGroups && comp.studentGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
