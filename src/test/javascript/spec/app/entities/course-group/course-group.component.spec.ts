...
import { CourseGroupComponent } from 'app/entities/course-group/course-group.component';
...
describe('Component Tests', () => {
  describe('CourseGroup Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.courseGroups && comp.courseGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
